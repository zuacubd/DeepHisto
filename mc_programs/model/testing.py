...
def testing_model(network_architecture):
    ...
    # Add the accuracy to the summary
    #tf.summary.matrix('Confusion', confusion)
    ...
    if network_architecture == "alexnet":
        checkpoint_path = "output/checkpoint/alexnet-Train-Test-Model_Epoch_20-2019-04-05-20:45:04.ckpt"

    elif network_architecture == "googlenet":
        checkpoint_path = "output/checkpoint/googlenet-Train-Test-Model_Epoch_20-2019-04-05-18:01:14.ckpt"
        ...
        checkpoint_path = "output/checkpoint/resnet50-Train-Test-Model_Epoch_20-2019-04-06-00:20:06.ckpt"
