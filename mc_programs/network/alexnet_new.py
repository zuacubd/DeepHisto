...
class AlexNet(object):
    """alexNet model"""
    def __init__(self, x, keepPro, classNum, skip, modelPath = "imagenet_models/bvlc_alexnet.npy"):
        self.X = x
    ...
    def buildCNN(self):
        ...
        fcIn = tf.reshape(pool5, [-1, int(np.prod(pool5.get_shape()[1:]))])

        #fc1 = fcLayer(fcIn, 256 * 6 * 6, 4096, True, "fc6")
        fc6 = fcLayer(fcIn, int(np.prod(pool5.get_shape()[1:])), 4096, True, "fc6")
