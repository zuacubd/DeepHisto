...
def predict_slide_model(network_name):
    ''' predicting the global level of each slides  '''
    ...
    network_predicted_path = prediction_folder + '/' + network_name + '.pred'
    result_folder = output_parameters['result_folder']
    result_file_path = result_folder + '/' + network_name + '_classification.res'
    ...
    slides_patches_predicted_lines = get_all_lines(network_predicted_path, header=True)
    ...
    print ("Num of actual slides: {}".format(len(actual_cls)))
    print ("Num of predicted slides: {}".format(len(predicted_cls)))
